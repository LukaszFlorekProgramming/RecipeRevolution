...
using RecipeRevolution.Domain.Exceptions;
...
namespace RecipeRevolution.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(RecipeRevolutionDbContext context, IPasswordHasher<User> passwordHasher, AuthenticationSettings authenticationSettings)
        {
            _context = context;
